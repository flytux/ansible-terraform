...
ENDPOINTS='https://192.168.100.152:2379'
ETCD_DATA_DIR="/var/lib/etcd"
BACKUP_DIR="/var/backups/kube_etcd/etcd-$(date +%Y-%m-%d-%H-%M-%S)"
KEEPBACKUPNUMBER='6'
ETCDBACKUPSCIPT='/usr/local/bin/kube-scripts'

ETCDCTL_CERT="/etc/ssl/etcd/ssl/admin-kubesphere-master-2.pem"
ETCDCTL_KEY="/etc/ssl/etcd/ssl/admin-kubesphere-master-2-key.pem"
